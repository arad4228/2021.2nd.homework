...
public class CalcGUIV1 extends JFrame implements ActionListener {
    ...
    Invoker invoker = new Invoker(noCommand);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        NumberButtonCommand numberButtonCommand = new NumberButtonCommand(calculator,cmdButton,display);
        EqualButtonCommand equalButtonCommand = new EqualButtonCommand(calculator,cmdButton,display);
        OperatorButtonCommand operatorButtonCommand = new OperatorButtonCommand(calculator,cmdButton,display);
...
//            calculator.clearFlags();
            invoker.SetCommand(equalButtonCommand);
                ...
                cmdButton == buttons[12] || cmdButton == buttons[13]) {
